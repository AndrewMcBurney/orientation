...
RSpec.describe SearchSnippet do
  ...
  context 'query string matches towards the begining of a sentance'
  context 'query string matches in the middle of a sentance'
  context 'query string matches towards the end of a sentance'
